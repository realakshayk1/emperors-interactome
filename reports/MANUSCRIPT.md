...
**Primary map.** The CM4AI multimodal cell map (Schaffer et al., *Nature* 2025, doi:10.1038/s41586-025-08878-3; NIH Bridge2AI *Cell Maps for AI* project: contact PI Trey Ideker (UC San Diego), co-PI Nevan Krogan (Gladstone Institutes / UCSF), whose lab supplied the interaction mapping), AlphaFold-Multimer interface confidence (ipTM) as the confidence axis. The map ships **1,788 native random-pair decoys**, which we use as calibration negatives — the feature that makes the map auditable.
