...
- **Primary map**: CM4AI, Schaffer et al., *Nature* 2025 (doi:10.1038/s41586-025-08878-3; Bridge2AI Cell Maps for AI project, contact PI Ideker (UCSD), co-PI Krogan (Gladstone/UCSF)); AlphaFold-Multimer ipTM as the confidence axis, with 1,788 native random-pair decoys as calibration negatives.
